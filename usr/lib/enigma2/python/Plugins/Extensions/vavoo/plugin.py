...
# def getWatchedSig():
    ...
    # while not sig2:
        ...
        # }
        # if PY3:
            # req = requests.post('https://www.rokkr.net/api/box/ping', json=data, headers=_headers).json()
        # else:
            # req = requests.post('https://www.rokkr.net/api/box/ping', json=data, headers=_headers, verify=False,).json()
        # if req.get('signed'):
            # sig2 = req['signed']
        # elif req.get('data', {}).get('signed'):
            # sig2 = req['data']['signed']
        # elif req.get('response', {}).get('signed'):
            # sig2 = req['response']['signed']
        # print('Sig2', sig2)
    # return sig2
